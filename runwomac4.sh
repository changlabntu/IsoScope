...
NO_ALBUMENTATIONS_UPDATE=1 python train.py --jsn cyc_imorphics --prj IsoMRIclean/gd1331fix/dis0 --models IsoMRIclean --cropz 16 --cropsize 128 --env brc --adv 1 --rotate --ngf 32 --direction ap --nm 11 --netG edclean --dataset womac4 --n_epochs 2000 --lr_policy cosine --mc --uprate 8 --lamb 1 --nocut --skipl1 4 --ndf 32 --fix_dis
